...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 100000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 100000},
	{model = 'suntrap', label = 'Suntrap', price = 200000},
	{model = 'jetmax', label = 'Jetmax', price = 400000},
	{model = 'tropic2', label = 'Tropic', price =  400000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 500000},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 500000},
	{model = 'speeder', label = 'Speeder', price = 500000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 500000},
	{model = 'toro', label = 'Toro', price = 800000},
	{model = 'submersible', label = 'Submersible', price = 800000}
}