...
Config.AircraftPoundPrice = 40000 -- How much it Costs to get Vehicle from Aircraft Pound.

Config.UseBoatGarages = false -- true = Allows use of Boat Garages.
Config.UseBoatBlips = false -- true = Use Boat Blips.
Config.BoatPoundPrice = 30000 -- How much it Costs to get Vehicle from Boat Pound.

Config.UseCarGarages = true -- true = Allows use of Car Garages.
Config.UseCarBlips = true -- true = Use Car Blips.
Config.CarPoundPrice = 20000 -- How much it Costs to get Vehicle from Car Pound.
