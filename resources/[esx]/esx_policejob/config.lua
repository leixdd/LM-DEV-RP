...
Config.AuthorizedWeapons = {
	recruit = {
		...
		{weapon = 'WEAPON_PUMPSHOTGUN', components = {0, 6000, nil}, price = 0},
		{weapon = 'WEAPON_NIGHTSTICK', price = 0},
		{weapon = 'WEAPON_STUNGUN', price = 0},
		{weapon = 'WEAPON_FLASHLIGHT', price = 0},
		{weapon = 'WEAPON_HEAVYSNIPER', components = {0, 6000, 1000, 4000, 8000, 0},price = 0},
		{weapon = 'WEAPON_CARBINERIFLE', components = {0, 6000, 1000, 4000, 8000, 8000, 8000, nil}, price = 0},
		{weapon = 'WEAPON_SNIPERRIFLE', components = {0, 6000, 6000, nil}, price = 0},
		{weapon = 'WEAPON_ASSAULTRIFLE', components = {0, 6000, 5000, 0, 8000, 8000, 8000, nil}, price = 0},
		{weapon = 'WEAPON_MICROSMG', components = {0, 6000, 1000, 4000, 8000, nil}, price = 0},
		{weapon = 'WEAPON_GRENADE', price = 0},
		{weapon = 'WEAPON_BZGAS', price = 0},
		{weapon = 'WEAPON_STICKYBOMB', price = 0},
