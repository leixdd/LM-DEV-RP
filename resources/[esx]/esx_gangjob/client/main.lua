...
Citizen.CreateThread(function()
  ...
  for k,v in pairs(Config.GangStations) do
    ...
    -- local redzone = AddBlipForRadius(blip, v.Blip.Radius)
    ...
    local blip = AddBlipForRadius(vector3(v.Blip.Pos.x, v.Blip.Pos.y, v.Blip.Pos.z), v.Blip.Radius) -- you can use a higher number for a bigger zone

      SetBlipHighDetail(blip, true)
      SetBlipColour(blip, 1)
      SetBlipAlpha (blip, 128)

    blip = AddBlipForCoord(vector3(v.Blip.Pos.x, v.Blip.Pos.y, v.Blip.Pos.z))
...
-- Citizen.CreateThread(function()
-- 	for k,zone in pairs(Config.GangStations) do
